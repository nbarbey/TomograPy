...
data = siddon.siddon.centered_stack(a, 128, n_images=60, radius=200., max_lon=np.pi)
# projection
t = time.time()
...
obj0 = siddon.backprojector(data, obj0)
print("backprojection time : " + str(time.time() - t))

obj1 = siddon.simu.object_from_header(object_header, fill=0.)
obj1 = siddon.backprojector(data, obj1)
